      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0 order-lg-2">
            <img src="{{ asset('frontend/images/homepage4.jpg') }}" alt="Image" class="img-fluid rounded">
          </div>
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row justify-content-center text-center mb-5 section-2-title">
          <div class="col-md-6">
            <h2 class="mb-4">Team Rent Car Surabaya</h2>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <img src="{{ asset('frontend/images/homepage.jpg') }}" alt="Image" class="img-fluid rounded">
          </div>
