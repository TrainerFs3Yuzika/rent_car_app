                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form action="/dashboard/bank/{{ $bank->slug }}" method="POST" class="d-inline" id="data-{{ $bank->slug }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button class="btn btn-danger shadow btn-xs sharp me-1 delete" data-name="{{ $bank->name }}" data-slug="{{ $bank->slug }}">
