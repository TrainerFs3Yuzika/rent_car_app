                            ...
                            <form action="/dashboard/bank" method="POST" class="mb-5" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-10">
                                    ...
                                    @enderror" placeholder="Masukkan Nama Bank" id="name" name="name" required autofocus value="{{ old('name') }}">
                                    @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      @enderror" placeholder="Masukkan Nomor Rekening" id="norek" name="norek" required autofocus value="{{ old('norek') }}">
                                      @error('norek')
                                        <div class="invalid-feedback">
                                          {{ $message }}
                                        </div>
