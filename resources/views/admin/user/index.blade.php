                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown ms-auto text-end">
                                                ...
                                                <a class="dropdown-item" href="/dashboard/user/{{$user->id}}">
                                                    <i class="fas fa-eye text-primary me-2"></i>Show
                                                </a>
                                                <a class="dropdown-item" href="/dashboard/user/{{$user->id}}/edit">
                                                    <i class="fas fa-edit text-warning me-2"></i>Edit
                                                </a>
                                                <form action="/dashboard/user/{{ $user->id }}" method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <button class="dropdown-item" onclick="return confirm('Yakin?')">
