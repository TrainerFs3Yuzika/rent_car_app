                        ...
                        <div class="card-body">
                            <form action="/dashboard/kendaraan" method="POST" class="mb-5" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    @enderror" placeholder="Masukkan Nama Kendaraan" id="nama" name="nama" required autofocus value="{{ old('nama') }}">
                                    @error('nama')
                                  ...
                                  <input type="text" class="form-control form-control-lg @error('plat_nomor') is-invalid @enderror" placeholder="Masukkan Plat Nomor" id="plat_nomor" name="plat_nomor" required value="{{ old('plat_nomor') }}">
                                  @error('plat_nomor')
                                      <div class="invalid-feedback">
                                          {{ $message }}
                                      </div>
                              ...
                              <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @enderror" placeholder="Masukkan Warna Kendaraan" id="warna" name="warna" required autofocus value="{{ old('warna') }}">
                                    @error('warna')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @enderror" placeholder="Masukkan Tahun Kendaraan" id="tahun" name="tahun" required autofocus value="{{ old('tahun') }}">
                                    @error('tahun')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @enderror" placeholder="Masukkan Harga" id="harga" name="harga" required autofocus value="{{ old('harga') }}">
                                    @error('harga')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
