            ...
            <form action="/dashboard/kendaraan/{{$kendaraan->slug}}" method="POST" class="mb-5"
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-lg @error('nama') is-invalid
                                    @enderror" placeholder="Masukkan Nama Kendaraan" id="nama" name="nama" required autofocus
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control form-control-lg @error('plat_nomor') is-invalid @enderror" placeholder="Masukkan Plat Nomor" id="plat_nomor" name="plat_nomor" required value="{{ old('plat_nomor', $kendaraan->plat_nomor) }}">
                  @error('plat_nomor')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-lg @error('warna') is-invalid
                                    @enderror" placeholder="Masukkan Warna Kendaraan" id="warna" name="warna" required autofocus
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-lg @error('tahun') is-invalid
                                    @enderror" placeholder="Masukkan Tahun Kendaraan" id="tahun" name="tahun" required autofocus
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-lg @error('harga') is-invalid
                                    @enderror" id="harga" placeholder="Masukkan Harga Sewa" name="harga" required autofocus
