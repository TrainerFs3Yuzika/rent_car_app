...
<head>
    <meta charset="utf-8">
    <title>Rent Surabaya - Not Found</title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="/" class="navbar-brand p-0">
                    <h1 class="m-0"><i class="fa fa-search me-2"></i>Rent<span class="fs-5">Surabya</span></h1>
                    ...
                    <div class="col-12 text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a class="text-white" href="/profile">Home</a></li>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-envelope me-3"></i>rentcarmotorsurabaya@gmail.com</p>
