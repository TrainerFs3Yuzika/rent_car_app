...
class KendaraanController extends Controller
{
    ...
    public function index()
    {
        ...
        // Penanganan pencarian berdasarkan jumlah penumpang
        if (request('jumlah_penumpang')) {
            $kendaraans->where('jumlah_penumpang', 'like', '%' . request('jumlah_penumpang') . '%');
        }
    ...
    public function create()
    {
        return view('admin.kendaraan.create', [
            ...
            'categories' => Category::all(),
            'types' => Type::all(),
            'jumlah_penumpang_options' => [1, 2, 3, 4, 5, 6],
